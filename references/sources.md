...
| `3acf3a2` | 对照历史版本补回事实保护、逻辑理解、文件范围与交付检查。 |
...
侧边聊天建议合并：已有的事实保护、句尾升华和术语一致性沿用原规则；补明个人感受来源、事件顺序、先修理解问题、简短回答的排版、聊天套话和中文层叠定语。三项检查示例合并成一句，保留全部对象。没有引入刻意交替句长、虚构个人反应或营销式情绪强化，也未将用户提供的项目热度写入规则。
