...
- **Review only:** give brief, specific feedback.
...
Keep the user's meaning, facts, stance, and level of certainty. Retain necessary technical terms while simplifying the language around them. Match the occasion's courtesy and formality with plain wording.
